...
function Start () {
	...
	GetComponent.<Rigidbody>().rotation.eulerAngles.y+=_rotationOffset+Random.Range(-_RandomRotationOffset, _RandomRotationOffset);
...
function OnCollisionEnter (col:Collision) {
	var e:GameObject = Instantiate(_explosion.gameObject, transform.position, GetComponent.<Rigidbody>().rotation);
